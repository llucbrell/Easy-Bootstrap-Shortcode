...
function ebs_shortcodes($shortcodes=array())
{
	$shortcodes = array(
			...
			'audio' => array('group' => 'interactive',
					'name' => 'Audio',
					'width' => '',
					'height' => '',
			),
			'embed' => array('group' => 'miscellaneous',
					'name' => 'Embed',
					'width' => '',
					'height' => '',
			),
...
function ebs_js_translation_assets($hook) {
	...
	wp_localize_script( 'ebs-js-translation-scripts', 'ebsjstrans', array(
			...
			'video' => __( 'Video', 'easy-bootstrap-shortcodes' ),
			'url' => __( 'URL', 'easy-bootstrap-shortcodes' ),
			'videosuport' => __( 'Responsive video platforms support', 'easy-bootstrap-shortcodes' ),
			'videoplatforms' => __( 'Youtube
				, Vimeo
				, Vine
				, Dailimotion', 'easy-bootstrap-shortcodes' ),

			

			'audio' => __( 'Audio', 'easy-bootstrap-shortcodes' ),
			'embedcode'=> __( 'Embeded Code', 'easy-bootstrap-shortcodes' ),
			'audiosuport' => __( 'Audio platforms tested support', 'easy-bootstrap-shortcodes' ),
			'audioplatforms' => __( 'SoundCloud
				, BandCamp
				, Spotify
				, MixCloud', 'easy-bootstrap-shortcodes' ),

			'map' => __( 'Google Maps', 'easy-bootstrap-shortcodes' ),
			'wmap' => __( 'Embeded gmaps code', 'easy-bootstrap-shortcodes' ),
