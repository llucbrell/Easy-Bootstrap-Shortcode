...
/* * *********************************************************
 * jQuery UI Header no margins insertion
 * ********************************************************* */
...
<div class="header center-block text-center' . $class .EBS_CONTAINER_CLASS. '"'.$style.'>' . do_shortcode($content) . '</div><div class="container new-main-content-area main-content-area"><div class="row full-width"><div class="new-main-content-inner col-sm-12 col-md-8"><div id="primary" class="new-content-area content-area"><div id="page"><div class="new-post-inner-content"><div class="entry-content"><script type="text/javascript">jQuery(document).ready(function($){
   ...
   $(\'.header > .iframe-container\').addClass( "hbs-no-padding-bottom" );
   });
</script>';
    return $out;
}

ebs_backward_compatibility_callback('header', 'osc_theme_header');
