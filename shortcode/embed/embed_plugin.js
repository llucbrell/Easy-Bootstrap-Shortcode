var embed={
    ...
    id :'oscitas-form-embed',
    pluginName: 'embed',
    showprobtn: false
};
(function() {
    _create_tinyMCE_options(embed);
})();

function ebs_return_html_embed(pluginObj){
    var form = jQuery('<div id="'+pluginObj.id+'" class="oscitas-container" title="'+pluginObj.title+'"><table id="oscitas-table" class="form-table">\
		 <tr class="tr-button-link">\
                <th><label for="oscitas-button-link">'+ebsjstrans.wembed+'</label></th>\
...
function create_oscitas_embed(pluginObj){
